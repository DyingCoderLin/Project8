...
CREATE TABLE `changetable` (
  `change_tableid` int NOT NULL AUTO_INCREMENT,
  `original_date` date DEFAULT NULL,
  `target_date` date DEFAULT NULL,
  `userid` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`change_tableid`),
  KEY `FKpn47m840pa4vku3dd9cb64cf0` (`userid`),
  CONSTRAINT `FKpn47m840pa4vku3dd9cb64cf0` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `changetable`
--
