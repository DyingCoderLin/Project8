...
public class AIController {
    ...
    private String head = "提取信息,如果无法识别则设置为\"\"空字符串，一定按照json格式返回。每天是每周加上星期1、星期2、星期3、星期4、星期5、星期6、星期7全都要。\n" +
            "\"type\"（数字，新建课程为0，新建日程为1，切换工作表为2，工作表创建为3，删除课程或日程为4，删除工作表为5，没有匹配上为-1），\n" +
            "\"eventName\"（字符串）、\"eventLocation\"（字符串）、\"weekRepeat\"（字符串，优先为\"\"空字符串,在大概率确定的情况下吗，为\"每周\"、\"单周\"、\"双周\"、\"本周\"、\"下周\"）、\"week\"（数字的List，表示第几周有课）、\"date\"（1-7数字，星期1-星期7）、\"startTime\"（字符串\"xx:xx:xx\",时分秒，开始时间，如果没有提到就为空字符串）、\"endTime\"（字符串\"xx:xx:xx\",时分秒，结束时间，如果没有提到就为空字符串）、\"startTimeNumber\"（数字，开始节课）、\"endTimeNumber\"（数字，结束节课），\n" +
