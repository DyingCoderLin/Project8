...
//todo: 完成之后的字符串给后端
  const handleFinish = async () => {
    ...
    await axios({
      method: 'post',
      url: 'http://192.168.5.144:8080/Ai/chat1',
            ...
            [
              {
                ...
                onPress: async () => {
                  await axios({
                    method: 'post',
                    url: 'http://192.168.5.144:8080/switchTable',
                    data: {
            ...
            [
              {
                ...
                onPress: async () => {
                  await axios({
                    method: 'post',
                    url: 'http://192.168.5.144:8080/deleteEvent',
                    data: {
            ...
            [
              {
                ...
                onPress: async () => {
                  ...
                  await axios({
                    method: 'post',
                    url: 'http://192.168.5.144:8080/deleteTable',
    ...
    >
      <LinearGradient colors={['#FF9E9E20', '#FF9E9E60']} style={styles.modalContent}>
        {isLoading ? (
            ...
            // 加载完成，显示输入框和按钮
            <>
              <Text style={styles.titleText}>给我提要求！！！！速速速！！！</Text>
              <TextInput
                  style={styles.input}
