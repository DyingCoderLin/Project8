...
//todo：处理保存逻辑
  const handleFinish = () => {
    ...
    axios({
      method: 'post',
      url: 'http://192.168.173.144:8080/addTableInfo',
...
{/* todo：上传背景图片    */}
    ...
    <View style={[styles.selectContainer,{justifyContent:'center'}]}>
      <TouchableOpacity onPress={() => navigation.navigate('TimeSetting', {courseNum: storageData.courseNum, courseTime: storageData.courseTime, tableData: storageData})} style={[styles.select,{justifyContent:'center'}]} >
